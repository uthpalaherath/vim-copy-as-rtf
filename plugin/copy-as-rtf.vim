...
function! s:CopyRTF(bufnr, line1, line2)
  ...
  if g:copy_as_rtf_using_local_buffer
    ...
    if &filetype ==# 'html'
      ...
      silent! %s#</head>#<style>body, pre, code { font-family: SF Mono, Monaco, monospace; font-size: 10.5pt; }</style></head>#e
    endif
    ...
    if &filetype ==# 'html'
      ...
      " Inject font family and size styling
      silent! %s#</head>#<style>body, pre, code { font-family: SFMono, Monaco, monospace; font-size: 10.5pt; }</style></head>#e
    endif
